...
export class classAmulets { // extends objectsLib {
  constructor(ObjectID, linkID){
    ...
    this._Obj = { 
      ...
      armorClass : null,
      armorType : null, 
      //required : new internalRequired(objectData.required).value,
      //textureObjectId : objectData.textureObjectId,
  ...
  // применить предмет
  use(){
    console.log("применить предмет:: ТИП: " + this._Obj.type + " ИМЯ: " + this._Obj.name + "classAmulets");
  }

  // отменить предмет
  cancelUse(){
    console.log("отменить предмет:: ТИП: " + this._Obj.type + " ИМЯ: " + this._Obj.name + "classAmulets");
  }
