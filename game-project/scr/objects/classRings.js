import data from "objects/data/dataRingsObjects";
...
export class classRings { // extends objectsLib {
  ...
  // применить предмет
  use(){
    console.log("применить предмет:: ТИП: " + this._Obj.type + " ИМЯ: " + this._Obj.name + " classRings");
  }

  // отменить предмет
  cancelUse(){
    console.log("отменить предмет:: ТИП: " + this._Obj.type + " ИМЯ: " + this._Obj.name + " classRings");
  }
