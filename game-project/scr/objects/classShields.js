import data from "objects/data/dataShieldsObjects";
...
export class classShields { // extends objectsLib {
  ...
  // применить предмет
  use(){
    console.log("применить предмет:: ТИП: " + this._Obj.type + " ИМЯ: " + this._Obj.name + " classShields");
  }

  // отменить предмет
  cancelUse(){
    console.log("отменить предмет:: ТИП: " + this._Obj.type + " ИМЯ: " + this._Obj.name + " classShields");
  }
